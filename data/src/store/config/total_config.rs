...
impl TotalConfig {
    pub fn get_default() -> Vec<TotalConfig> {
        ...
        let vbiquge = TotalConfig {
            main_page_url: "https://www.vbiquge.com/".to_string(),
            name: "新笔趣阁1".to_string(),
            search: SearchConfig {
                li: "body > div.result-list > div".to_string(),
                novel_id: "div.result-game-item-detail > h3 > a".to_string(),
                author_name:
            ...
            url: UrlConfig {
                search: "https://www.vbiquge.com/search.php?keyword={##searchName##}".to_string(),
                novel_info: "https://www.vbiquge.com/{##novelId##}/".to_string(),
                directory: "https://www.vbiquge.com/{##novelId##}/".to_string(),
                chapter: "https://www.vbiquge.com/{##novelId##}/{##chapterId##}.html".to_string(),
                search_placeholder: "{##searchName##}".to_string(),
                novel_placeholder: "{##novelId##}".to_string(),
                chapter_placeholder: "{##chapterId##}".to_string(),
            },
